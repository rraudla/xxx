...
APP_NAME = 'WATDjango title'  # Add

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/3.0/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = '%&8v3737o_c_k4aslcrl6aip3s_&5(mf*x+-9-(ss^eop=+6wk'
# SECRET_KEY = 'g$iqqu&*mw4_sg3(#ld0sqaalxebel&168^yj%i&sgrw(fmn@w'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['80e30cbdc7e3.ngrok.io',
                 '127.0.0.1'
                 ]
...
INSTALLED_APPS = [
    ...
    'maakonnad.apps.MaakonnadConfig',
...
WSGI_APPLICATION = 'WATDjango.wsgi.application'
